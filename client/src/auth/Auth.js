...
export default function Auth() {
    ...
    return (_jsxs("div", { children: [loading && (_jsx("div", { className: "w-screen h-screen flex justify-center items-center z-50 bg-slate-950", children: _jsx(LoadingPage, {}) })), error && (_jsx("div", { className: "error-message text-center mt-4 text-red-600", children: error }))] }));
}
